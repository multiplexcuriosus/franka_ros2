...
def generate_robot_nodes(context):
    ...
    hand_prefix = LaunchConfiguration('hand_prefix').perform(context)
    # Declare the launch argument names
    modified_hand_prefix = '' if not hand_prefix else hand_prefix + '_'
    default_joint_name_postfix = '_finger_joint'
    joint_names_1 = modified_hand_prefix + arm_id + default_joint_name_postfix + '1'
    joint_names_2 = modified_hand_prefix + arm_id + default_joint_name_postfix + '2'
    ...
    nodes.append(
        Node(
                ...
                name=[modified_hand_prefix + 'franka_gripper'],
                namespace=namespace,
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                default_value='',
                description=(
                    'Prefix for topic name and joint names'
                ),
            ),
